...
const Works = () => {
  return (
   ...
   <a href="http://covid-19-viruss.netlify.app" target="_blank" rel="noopener noreferrer"><p className='para'>COVID-19 TRACKER (click)</p><img src={p1} alt="" className='worksImg' /></a>
